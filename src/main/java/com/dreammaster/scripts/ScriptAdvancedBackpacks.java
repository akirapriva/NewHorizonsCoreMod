...
public class ScriptAdvancedBackpacks implements IScriptLoader {
    ...
    public List<String> getDependencies() {
        return Arrays.asList(AdventureBackpack.ID);
    }
    ...
    public void loadRecipes() {
        ...
        if (ABML) {
            ...
            GTValues.RA.stdBuilder().itemInputs(getModItem(Minecraft.ID, "melon", 1, 0, missing))
                    ...
                    .fluidOutputs(FluidRegistry.getFluidStack("melonjuice", 750)).duration(6 * SECONDS + 8 * TICKS)
                    .eut(4).addTo(brewingRecipes);
